...
exports.RecoverAccessProfileService = void 0;
...
let RecoverAccessProfileService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    accessProfiles.forEach(accessProfile => {
      accessProfile.status = _eStatus.EAccessProfileStatus.Active;
...
exports.RecoverAccessProfileService = RecoverAccessProfileService;